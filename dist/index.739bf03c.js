...
var _warriorsJs = require("./warriors.js");
var _warriorsJsDefault = parcelHelpers.interopDefault(_warriorsJs);
...
const startLol = async ()=>{
    ...
    try {
        ...
        Object.keys(warriors).forEach((character)=>{
            allwarriors.push(new (0, _warriorsJsDefault.default)(warriors[character]));
        });
        await showWarriors();
    } catch (error) {
...
const showWarriors = async ()=>{
    ...
    container.innerHTML = "";
    for(let i = 0; i < allwarriors.length; i++)container.innerHTML += `
    <div class="card">
...
},{"./warriors.js":"bxC9F","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bxC9F":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}]},["l9Mez","ebWYT"], "ebWYT", "parcelRequire3334")
